...
ngx_uint_t             ngx_test_config;    /* 标志命令行中传入了 -t 参数 */
ngx_uint_t             ngx_quiet_mode;     /* 标志命令行中传入了 -q 参数 */
...
/*
 * 将master 或 single 进程id 写到 name文件中
 */
ngx_int_t
...
/*
 * 读取pid文件获取当前运行的master进程的pid并发送sig信号
 */
ngx_int_t
